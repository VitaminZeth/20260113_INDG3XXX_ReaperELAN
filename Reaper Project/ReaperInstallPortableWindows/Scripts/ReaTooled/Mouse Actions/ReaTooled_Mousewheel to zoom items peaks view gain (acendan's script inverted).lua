...
-- @author Aaron Cendan-- @author Brenadn Baker (But really modified/copied from Aaron Cendan)
-- @version 1.0
-- @metapackage
-- @provides
...
function Main()
  ...
  if val < 0 then
    for i = 0, speed do
      reaper.Main_OnCommand(40155, 0) -- Peaks: Decrease peaks view gain
    end
  else
    for i = 0, speed do
      reaper.Main_OnCommand(40156, 0) -- Peaks: Increase peaks view gain
    end
  end
