-- @description ReaTooled - Trim Tool
-- @version 1.2
-- @date 2024.06.13
-- @author Brendan Baker
-- @link https://brendanpatrickbaker.com/reatooled/
-- @about
--   # This script loads a set of mouse modifiers focusing on trimming the edge of items, which gives similar functionality to ProTools' "Trim Tool."
-- CHANGELOG
